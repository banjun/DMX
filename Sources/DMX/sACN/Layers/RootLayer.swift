...
public struct RootLayer: MemoryMappedPacketOrLayer, Sendable {
    ...
    public var vector: MemoryMappedEnum<Vectors.Root>
    ...
    public init(preambleSize: UInt16BE = 0x0010, postambleSize: UInt16BE = 0x0000, acnPacketIdentifier: (UInt32BE, UInt32BE, UInt32BE) = (0x4153432d, 0x45312e31, 0x37000000), flagsAndLength: FlagsAndLength = .init(rawValue: 0x726E), vector: Vectors.Root, cid: CID) {
